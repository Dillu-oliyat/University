...
<div class="super_container">
                    ...
                    if(isset($_POST["submit"]))
 {
	 ...
	 echo "<script>alert('Message Send successfully');document.location.href='contact.php';</script>";
	 }
	 else
	 {
	
	 echo "<script>alert('inserted failed');document.location.href='contact.php';</script>";
	 } 
 }
 ?>
