        ...
        <div class="grid_10">
            <div class="box round first">
              ...
              <?php
				   ...
				   $res="select * from college_register where status='0'";
				   $result=mysql_query($res,$connection);
				   echo"<table border='1'><tr bgcolor='#006699' height='50'><th>id</th><th>University</th><th>Catogory</th><th>CollegeName</th><th>Type</th><th>UG Courses</th><th>PG Courses</th></tr>";
				  $idd='1';
				...
				$ug=$fetch['ug_course'];
					   ...
					   echo "<td>$ug</td>";
					   echo"<td>"; 
	 echo"<form action='admin_collegedetails.php' method='post'><input type='hidden' name='hidid' value='{$id}'/> <input type='submit' name='btnDtls' value='Details' /></td></tr></form>";
					     $idd++;
