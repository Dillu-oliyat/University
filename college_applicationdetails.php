...
$db=mysql_select_db("university");
 ...
 $retriv="select * from registration where id='$iid'";
...
//	$utype=$_POST['hid2'];
	...
	$updt="update registration set status='selected' where id='$id'";
  ...
  if(isset($_POST["btnDelete"]))
 {
	 ...
	 $delete="update registration set status='rejected' where id='$id'";
