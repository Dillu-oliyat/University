				...
				<div class="col-lg-4 course_box">
					<div class="card">
						...
						<div class="price_box d-flex flex-row align-items-center">
							...
							<div class="course_author_name"><?php echo"<form action='' method='post'><input type='hidden' name='hidid' value='{$university}'/> <input type='submit' class='' name='btn' value='Click Here For More Details'></form>"; ?></div>
