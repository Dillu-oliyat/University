				 ...
				 if(isset($_POST["csub"]))
{
				   ...
				   $db=mysql_select_db("university");
				   $course=$_POST['course'];
				   $res="select * from  registration where email='$username' and course='$course' and status='0' ORDER BY total_mark DESC LIMIT 100  ";
				...
				$total_mark=$fetch['total_mark'];
					   ...
					   echo"<td>"; 
	 echo"<form action='college_applicationdetails.php' method='post'><input type='hidden' name='hidid' value='{$id}'/> <input type='submit' name='btnDtls' value='Details' /></td></tr></form>";
					     $idd++;
