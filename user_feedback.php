...
<div class="super_container">
					...
					<div class="contact_form">
						...
						<div class="contact_form_container">
							<form action="#" method="post">
								...
								<textarea id="contact_form_message" class="text_field contact_form_message" name="feedback" placeholder="Feedback" required="required" data-error="Please, write us a message."></textarea>
								<input id="submit" name="submit" type="submit" class="contact_send_btn trans_200" value="Submit">
							</form>
							<?php
                    ...
                    if(isset($_POST["submit"]))
 {
	 ...
	 $insert="insert into feedback(name,email,feedback)values('{$name}','{$email}','{$feedback1}')";
	 ...
	 echo "<script>alert('feedback Send successfully');document.location.href='user_feedback.php';</script>";
	 }
	 else
	 {
	
	 echo "<script>alert('inserted failed');document.location.href='user_feedback.php';</script>";
	 } 
 }
 ?>
