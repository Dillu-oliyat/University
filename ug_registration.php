...
<tr>
<td>FIRST NAME</td>
<td><input type="text" class="input_field contact_form_name" name="First_Name" id="firstname" maxlength="30" required/>
...
<td>GENDER</td>
<td>
Male <input type="radio" name="gender" value="Male" id="gender" required />
Female <input type="radio" name="gender" value="Female" id="gender" required />
</td>
</tr>
...
<td>
<input type="text" name="course" value="<?php echo $course1; ?>" maxlength="30" />
</td>
</tr>
<tr>
<td>TOTAL MARK<br />(IN PERSENTAGE)</td>
<td>
<input type="text" name="tmark"  maxlength="30" id="tmark" required />
</td>
</tr>
...
if(isset($_POST["submit"]))
		 ...
		 $collegename=$_SESSION["collegename"];	
				...
				$Course=$_POST['course'];
				 ...
				 $query="insert into ug_registration(first_name,last_name,date_of_birth,email_id,mobile_number,gender,address,city,pincode,state,biodata,photo,hobbies,course,type,status,collegename,email,total_mark)values('$firstname','$lastname','$dob','$Email_Id','$Mobile_Number','0','$Address','$City','$Pin_Code','$State','$dest','$dest1','Dancing','$Course','ug','0','$collegename','$email','$tmark')";
