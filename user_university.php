		...
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="section_title text-center">
						<h1>Popular Universities In Kerala</h1>
					</div>
				</div>
			</div>
			...
			<div class="row course_boxes">
				...
				<div class="col-lg-4 course_box">
					<div class="card">
						<img class="card-img-top" src="<?php echo $image;  ?>"  alt="https://unsplash.com/@kellybrito">
						<div class="card-body text-center">
							<div class="card-title"><a href="courses.html"><?php  echo"$university"; ?></a></div>
							<div class="card-text"><?php  echo"$address"; ?></div>
						</div>
						<div class="price_box d-flex flex-row align-items-center">
							<div class="course_author_image">
								
							</div>
							<div class=""><?php echo"<form action='university_college_details.php' method='post'><input type='hidden' name='hidid' value='{$university}'/> <input type='submit' class='' name='btn' value='Click Here For More Details'></form>"; ?></div>
