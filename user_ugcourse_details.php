    ...
    <tr height="50"><th bgcolor="#666666"><?php echo "$collegename"; ?></th></tr></table><br> </form>
	  ...
	  <?php
			...
			$hhhh=$_POST['hhhh'];  
			 ...
			 $res="select * from  college_addcourse where id='$hhhh'";
       ...
       <table border=""><tr height="40"><td> <?php  echo"<form action='ug_registration.php' method='post'><input type='hidden' name='hhddd' value='{$id}'/><input type='submit' name='reg' value='Click Here FOr Registration'></form>"; ?></td></tr></table>
